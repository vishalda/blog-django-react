      ...
      <div
        className={
          localStorage.getItem("dark") === "true"
            ? "home dark-theme-home"
            : "home"
        }
      >
        <Base />
        <div className="home-page-svg">
          <HomePageSvg className="HomeSvg" />
        </div>
        ...
        <div className="home-page-content">
          ...
          {IsAuthenticated() && (
            <div>
              <h4>
                A simple Blog which has basic CRUD functionality for editing
                posts.
                <br />
                <br /> Interested in publishing a new post?{" "}
                <Link to="/create-post" style={{ color: "#6c63ff" }}>
                  Create-Post
                </Link>
              </h4>
              <br />
          ...
          <h5>
            Source code : &nbsp;
            <a href="https://github.com/VDA-001/blog-django-react">
              <FaGithubSquare
                className={
                  localStorage.getItem("dark") === "true"
                    ? "text-light github-icon"
                    : "text-dark github-icon"
                }
              />
            </a>
          </h5>
        ...
        >
          ...
          <h5 style={{ position: "relative", float: "left" }}>
            Made with <BsHeartFill style={{ color: "red" }} /> by Tanuja & Roopa
          </h5>
          <h5 style={{ position: "relative", float: "right" }}>
            Connect with me :{" "}
            <a href="https://github.com/VDA-001">
